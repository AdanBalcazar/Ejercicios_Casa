...
Con la tecla L se alterna la posición de la fuente de iluminación
...
void display(void)
{
	...
	model = glm::rotate(model, glm::radians(nucleo), glm::vec3(0.0f, 1.0f, 0.0f));  //Movimiento de rotación
	...
	//Electrón 1
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron1), glm::vec3(0.0f, 1.0f, 0.0f));  //Movimiento de traslación
	model = glm::translate(model, glm::vec3(5, 0, 0));
	model = glm::rotate(model, glm::radians(electron1), glm::vec3(0.0f, 1.0f, 0.0f));  //Movimiento de rotación
	model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 1.0f);
	...
	//Electrón 2
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron2), glm::vec3(0.0f, 0.0f, 1.0f));  //Movimiento de traslación
	model = glm::translate(model, glm::vec3(5, 0, 0));
	model = glm::rotate(model, glm::radians(electron2), glm::vec3(0.0f, 1.0f, 0.0f));  //Movimiento de rotación
	model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 1.0f, 0.0f);
	...
	//Electrón 3
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron3), glm::vec3(1.0f, 0.0f, 0.0f));  //Movimiento de traslación
	model = glm::translate(model, glm::vec3(0, 0, 5));
	model = glm::rotate(model, glm::radians(electron3), glm::vec3(1.0f, 0.0f, 0.0f));  //Movimiento de rotación
	model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 1.0f, 0.0f);
	...
	//Electrón 4
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron4), glm::vec3(1.0f, 1.0f, 0.0f));  //Movimiento de traslación
	model = glm::translate(model, glm::vec3(0, 0, 5));
	model = glm::rotate(model, glm::radians(electron4), glm::vec3(1.0f, 0.0f, 0.0f));  //Movimiento de rotación
	model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 1.0f, 0.0f);
	...
	//Electrón 5
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron5), glm::vec3(1.0f, -1.0f, 0.0f));  //Movimiento de traslación
	model = glm::translate(model, glm::vec3(0, 0, 5));
	model = glm::rotate(model, glm::radians(electron5), glm::vec3(1.0f, 0.0f, 0.0f));  //Movimiento de rotación
	model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("ambientColor", 0.0f, 0.0f, 1.0f);
	projectionShader.setVec3("diffuseColor", 0.0f, 1.0f, 0.0f);
	...
	//Anillo 2
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(electron2), glm::vec3(0.0f, 0.0f, 1.0f));  //Movimiento de rotación
